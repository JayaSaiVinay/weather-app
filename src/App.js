    ...
    <main>
      <div className="search-container">
        <form action="" className="search-bar">
          <input type="text" placeholder="Search the Area" />
          <button type="submit">
      ...
      <div className="weather-data">
        <p className="location">Amalapuram, Andhra Pradesh, India</p>
        <div className="current-weather">
          <p>Current Weather: Light drizzle </p>
          <img src="//cdn.weatherapi.com/weather/64x64/day/266.png" />
        </div>
        ...
        <p>Last Updated: 2023-07-18 04:30</p>
      </div>
    </main>
  );
}
